...
**Estacionalidad en estados de la  Península de Yucatán** 
```{r, fig.height=6, fig.width = 10}
...
```
Fuente:  Elaboración propia con dats de [siap](http://infosiap.siap.gob.mx/repoAvance_siap_gb/pecAvanceProd.jsp)
